...
exports.config = {
    ...
    // Run and individual suite example "npx wdio wdio.conf.js --suite advnew"
    suites: {
    ...
    baseUrl: "http://williamclarke.com",
    //
   ...
   */
    ...
    // TODO: Get Project Key from Test
        if (process.env.ZEPHYR_UPLOAD_RESULT==="TRUE") {
            const zephyrScale = require("./helper/zephyrScaleHelper")
